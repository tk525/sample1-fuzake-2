...
def hello():
    ...
    aboutMe5="2021年6月から東京へセーブポイント変更と同時に、IT企業に入社し、7月から案件に出征中です。"
    aboutMe6="尚、前職では「自由にさせると本領発揮するタイプ」と言われたことがある模様。"
    ...
    LikeHate8="また、留学中に現地の人や観光客に、笑顔で手を振りながら現地後で挨拶をずっと続ける奇行を突然行うことがあります。結果、韓国の観光客の人達と一緒に写真撮ったり、現地のこどもとジェスチャーでコミュニケーションをとったりしていました。"
    ...
    FreeTime5="と書きましたが、突然散歩という名の冒険に出かけたりします"
    ...
    News6="最近発見した事は、最寄駅に靴の修理屋さんが閉店しており、1件もない事でした。悲しみの反動で、靴と添い寝しました。"
