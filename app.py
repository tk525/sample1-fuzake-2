...
def hello():
    ...
    LikeHate8="また、留学中に現地の人や観光客に、笑顔で手を振りながら現地語で挨拶をずっと続ける奇行を突然行うことがあります。結果、韓国の観光客の人達と一緒に写真撮ったり、現地のこどもとジェスチャーでコミュニケーションをとったりしていました。"
    ...
    News6="最近あったことは、靴の修理屋さんが一軒もなかった事です。涙で枕を濡らしながら、靴と添い寝していました。"
